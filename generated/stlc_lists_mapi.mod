...
step (mapi (emptyList ) V1 V2) (emptyList ) :- value V1, value V2.

step (mapi (cons E1 E2) V3 V4) (cons (app (app V3 V4) E1) (mapi E2 V3 (succ V4))) :- value E1, value E2, value V3, value V4.
...
step (mapi E1 E2 E3) (mapi E1 E2 E3') :- step E3 E3', value E1, value E2.
...
step (mapi E1 E2 E3) E2 :- error E2.

step (mapi E1 E2 E3) E3 :- error E3.
