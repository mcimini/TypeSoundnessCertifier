...
step (reverseRange (succ E)) (cons (succ E) (reverseRange E)) :- value E.
...
step (reverse (cons E1 E2)) (append (reverse E2) (cons E1 (emptyList ))) :- value E1, value E2.

typeOf (append E1' E2') (list T) :- typeOf E1' (list T), typeOf E2' (list T).

step (append (emptyList ) V) V :- value V.

step (append (cons E1 E2) V3) (cons E1 (append E2 V3)) :- value E1, value E2, value V3.
...
step (range V) (reverse (reverseRange V)) :- value V.
