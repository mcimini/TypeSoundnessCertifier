...
step (filter (emptyList ) V) (emptyList ) :- value V.

step (filter (cons E1 E2) V3) (if (app V3 E1) (cons E1 (filter E2 V3)) (filter E2 V3)) :- value E1, value E2, value V3.
