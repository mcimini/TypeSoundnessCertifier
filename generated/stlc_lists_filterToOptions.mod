...
step (filterToOptions (emptyList ) V1 V2) (emptyList ) :- value V1, value V2.

step (filterToOptions (cons E1 E2) V3 V4) (cons (if (app (app V3 V4) E1) (some E1) (none )) (filterToOptions E2 V3 (succ V4))) :- value E1, value E2, value V3, value V4.
...
step (filterToOptions E1 E2 E3) (filterToOptions E1 E2 E3') :- step E3 E3', value E1, value E2.
...
step (filterToOptions E1 E2 E3) E2 :- error E2.

step (filterToOptions E1 E2 E3) E3 :- error E3.
